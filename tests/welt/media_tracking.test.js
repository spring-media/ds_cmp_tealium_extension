...
describe('Media Tracking', () => {
    ...
    describe('Initialization checks', () => {
        it('should not execute when window.utag is not defined', () => {
            delete mockWindow.utag;
            delete global.utag;

            // Simulate the extension code
        ...
        it('should not execute when utag.link is not defined', () => {
            mockUtag.link = undefined;
            mockWindow.utag.link = undefined;
        ...
        it('should not execute when eventData is not provided', () => {
