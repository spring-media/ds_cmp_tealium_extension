const getNmtAppInfo = {
    ...
    getAppName: function (appIdentifier) {
      ...
      const bildNews = ['de.bild.newsapp', 'de.bild.newsapp-legacy', 'de.bild.ipad-legacy', 'de.bild.ipad', 'com.netbiscuits.bild.android', 'de.bild.MeinKlub'];
      const bildSport = ['de.bild.bundesliga-legacy', 'de.bild.bundesliga'];
      const weltNews = ['de.cellular.n24hybrid', 'de.cellular.n24hybrid.staging', 'de.axelspringer.weltmobil'];
      const weltEdition = ['com.sprylab.axelspringer.tablet.welt', 'de.axelspringer.weltipad', 'de.axelspringer.weltipad', 'de.axelspringer.SessionPaymentFeaturesPreview'];
